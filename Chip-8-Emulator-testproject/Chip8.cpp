...
void Chip8::initialize()
{
	...
	// clear keyboard states and cpu registers
	for (int i = 0; i < 16; i++)
		key[i] = V[i] = 0;
		...
		case 0x0000:
			switch(opcode & 0x000F)
			{
				...
				case 0x000E: // 0x00EE Returns from subroutine
					sp--;	// 16 levels of stack, decrease the stack pointer do prevent override
					pc = stack[sp]; // put the stored return adress from stack back into the program counter
					pc += 2;	// dont forget to increase the program counter
				break;
